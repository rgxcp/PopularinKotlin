...
class LikeFromFollowingRequest(private val context: Context, private val reviewID: Int) {
    fun sendRequest(page: Int, callback: LikeFromFollowingRequestCallback) {
        val requestURL = "${PopularinAPI.REVIEW}$reviewID/likes/from/following?page=$page"

        val likeFromFollowing = object : JsonObjectRequest(Method.GET, requestURL, null, Response.Listener { response ->
