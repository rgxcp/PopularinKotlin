...
class WatchlistFromAllRequest(private val context: Context, private val filmID: Int) {
    fun sendRequest(page: Int, callback: WatchlistFromAllRequestCallback) {
        val requestURL = "${PopularinAPI.FILM}$filmID/watchlists/from/all?page=$page"

        val watchlistFromAll = object : JsonObjectRequest(Method.GET, requestURL, null, Response.Listener { response ->
