...
class AddWatchlistRequest(private val context: Context, private val filmID: Int) {
    fun sendRequest(callback: AddWatchlistRequestCallback) {
        val requestURL = "${PopularinAPI.FILM}$filmID/watchlist"

        val addWatchlist = object : JsonObjectRequest(Method.POST, requestURL, null, Response.Listener { response ->
