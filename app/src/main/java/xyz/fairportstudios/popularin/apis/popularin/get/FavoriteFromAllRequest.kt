...
class FavoriteFromAllRequest(private val context: Context, private val filmID: Int) {
    fun sendRequest(page: Int, callback: FavoriteFromAllRequestCallback) {
        val requestURL = "${PopularinAPI.FILM}$filmID/favorites/from/all?page=$page"

        val favoriteFromAll = object : JsonObjectRequest(Method.GET, requestURL, null, Response.Listener { response ->
