...
class UnlikeReviewRequest(private val context: Context, private val reviewID: Int) {
    fun sendRequest(callback: UnlikeReviewRequestCallback) {
        val requestURL = "${PopularinAPI.REVIEW}$reviewID/unlike"

        val unlikeReview = object : JsonObjectRequest(Method.DELETE, requestURL, null, Response.Listener { response ->
