...
class UserWatchlistRequest(private val context: Context, private val userID: Int) {
    fun sendRequest(page: Int, callback: UserWatchlistRequestCallback) {
        val requestURL = "${PopularinAPI.USER}$userID/watchlists?page=$page"

        val userWatchlist = object : JsonObjectRequest(Method.GET, requestURL, null, Response.Listener { response ->
