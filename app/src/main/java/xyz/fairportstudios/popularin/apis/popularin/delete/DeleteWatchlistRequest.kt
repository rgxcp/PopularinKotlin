...
class DeleteWatchlistRequest(private val context: Context, private val filmID: Int) {
    fun sendRequest(callback: DeleteWatchlistRequestCallback) {
        val requestURL = "${PopularinAPI.FILM}$filmID/unwatchlist"

        val deleteWatchlist = object : JsonObjectRequest(Method.DELETE, requestURL, null, Response.Listener { response ->
